          ...
          <div className="space-y-4 animate-fade-in">
            <div className="p-3 bg-amber-50 border border-amber-200 rounded-xl text-xs text-amber-900">
              ...
              <p className="text-[11px] text-amber-800 mt-0.5">
                Ingresa tu correo institucional y te enviaremos un enlace de acceso seguro.
              </p>
            </div>
        ...
        <div className="pt-4 border-t border-slate-100 space-y-2">
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            >
              ...
              <span className="block text-[10px] text-slate-500">Vendedor Senior POS</span>
            </button>
            ...
            >
              ...
              <span className="block text-[10px] text-slate-500">Sales Manager / Admin</span>
            </button>
          </div>
        </div>
