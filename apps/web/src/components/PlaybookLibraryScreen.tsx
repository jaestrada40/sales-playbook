...
export const PlaybookLibraryScreen: React.FC<PlaybookLibraryScreenProps> = ({
  ...
  const filteredPlaybooks = playbooks.filter((pb) => {
    ...
    const matchesLanguage =
      languageFilter === "all" || pb.language === languageFilter;
    const matchesIndustry =
      industryFilter === "all" || pb.industry === industryFilter;
          ...
          >
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <span
                  className={`px-2.5 py-1 rounded-md text-[11px] font-extrabold border ${
                    pb.status === "publicado"
